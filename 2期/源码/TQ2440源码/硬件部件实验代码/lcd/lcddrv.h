...
/* 
 * TQ2440 4.3英寸LCD手册为TQ043TSCM_V0.1_40P.pdf
 * 具体参数在第5页
 *
 * WXCAT43-TG6#001_V1.0.pdf第22、23页,更清楚,两个文件的参数是一样的
 * 
...
#define CLKVAL_TFT_480272	(4)  /* LCD手册表示Dclk=9MHz~15MHz, HCLK=100MHz, Dclk=VCLK=HCLK/[(CLKVAL+1)x2]=100/((4+1)*2)=10MHz */
