cmd_drivers/media/video/uvc/uvc_queue.o := /opt/buildroot-gcc342/bin/mipsel-linux-uclibc-gcc -Wp,-MD,drivers/media/video/uvc/.uvc_queue.o.d  -nostdinc -isystem /opt/buildroot-gcc342/bin/../lib/gcc/mipsel-linux-uclibc/3.4.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Os  -mabi=32 -G 0 -mno-abicalls -fno-pic -pipe -msoft-float -ffreestanding  -march=mips32r2 -Wa,-mips32r2 -Wa,--trap -Iinclude/asm-mips/rt2880 -Iinclude/asm-mips/mach-generic -fomit-frame-pointer -gdwarf-2  -membedded-data -muninit-const-in-rodata -funit-at-a-time -Wdeclaration-after-statement     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(uvc_queue)"  -D"KBUILD_MODNAME=KBUILD_STR(uvcvideo)" -c -o drivers/media/video/uvc/uvc_queue.o drivers/media/video/uvc/uvc_queue.c
